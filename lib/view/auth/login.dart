...
//                       Get.snackbar('Error', 'Enter a 4-digit PIN');
//                       return;
//                     }
...
//                   children: [
//                     const Text("Don't Remember PIN? ", style: TextStyle(color: AppColors.white)),
//                     GestureDetector(
//                       onTap: () {
//                         // TODO: Add reset PIN flow
//                         Get.snackbar('Coming Soon', 'PIN reset feature');
//                       },
//                       child: const Text("Reset PIN", style: TextStyle(color: AppColors.primary)),
//                     ),
//                   ],
//                 ),
//                 const SizedBox(height: 25),
...
//                   ),
//                   child: const Icon(Icons.fingerprint, color: AppColors.surface, size: 30),
//                 ),
